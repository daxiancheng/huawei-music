...
var swiper = function swiper(node) {
  ...
  root.ontouchmove = function (e) {
    ...
    clearTime = setTimeout(function () {
      if (newX - oldX > 50) {
        swiperMethod.swipRight.forEach(function (fn) {
          return fn.bind(root)();
        });
      } else if (oldX - newX > 50) {
        swiperMethod.swipLeft.forEach(function (fn) {
          return fn.bind(root)();
        });
      }
    }, 100);
...
function () {
  ...
  _createClass(player, [{
    ...
    value: function bind() {
      ...
      var swiper = new _swiper.default(this.root.querySelector('.mainShow'));
      swiper.on('swipLeft', function () {
    ...
    value: function loadSong() {
      ...
      //加载歌曲
      var songObj = this.playList[this.currentIndex];
      ...
      this.audio.onloadedmetadata = function () {
        return _this4.root.querySelector('.timeEnd').innerText = _this4.formatTime(_this4.audio.duration);
      }; //歌词总时长（毫秒）
    ...
    key: "formatTime",
    value: function formatTime(totalTime) {
    ...
    value: function loadlyric() {
      ...
      //加载歌词
      fetch(this.playList[this.currentIndex].lyric).then(function (res) {
        return res.json();
      }).then(function (data) {
        return _this5.formatlyrics(data.lrc.lyric);
      });
    }
  }, {
    key: "formatlyrics",
    value: function formatlyrics(lyric) {
      var _this6 = this;
      ...
      lyric.split(/\n/).filter(function (str) {
        ...
        line.match(/\[.+?\]/g).forEach(function (t) {
          ...
          _this6.lyricArr.push([milliseconds, str]);
        });
      });
      this.lyricArr.filter(function (line) {
        return line[1].trim() !== '';
      }).sort(function (v1, v2) {
        return v1[0] - v2[0];
      }).forEach(function (line) {
    ...
    value: function localLyics(node) {
      ...
      this.root.querySelectorAll('.mainShow2 .contentLyics p').forEach(function (element) {
...
},{"./icon":"src/javascript/icon.js","./swiper":"src/javascript/swiper.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/javascript/index.js"], null)
